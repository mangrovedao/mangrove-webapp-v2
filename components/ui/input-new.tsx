...
const inputClasses =
  "flex h-11 w-full rounded-2xl border-none transition-all bg-bg-secondary text-md placeholder:text-text-placeholder focus-visible: disabled:cursor-not-allowed disabled:bg-gray-scale-600 disabled:!border-transparent disabled:text-gray-scale-300"
