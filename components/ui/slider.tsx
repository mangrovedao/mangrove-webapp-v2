...
>(({ className, ...props }, ref) => (
  <>
    ...
    >
      ...
      <SliderPrimitive.Thumb className="z-50 p-[2px] font-extralight text-xs focus-visible:outline-none active:!text-gray-scale-200 border-[0.5px] border-bg-tertiary hover:bg-bg-tertiary cursor-pointer whitespace-nowrap rounded-sm bg-bg-secondary transition-colors disabled:pointer-events-none disabled:opacity-50">
